      ...
      <div className="max-w-3xl mx-auto space-y-4">
        ...
        {!user ? (
          <div className="space-y-3">
            <p className="text-gray-600">ما سجلت دخول</p>
          ...
          <div className="space-y-3">
            <div className="p-4 rounded-2xl border">
              <p className="text-sm text-gray-500">تسجيل دخول كـ</p>
              <p className="font-semibold">{profile?.name || user.email}</p>
              <p className="text-sm">
                نوع المستخدم؟ <span className="font-semibold">{profile?.role || "unknown"}</span>
              </p>
              <p className="text-sm">
                Email verified:{" "}
            ...
            <div className="flex flex-wrap gap-3">
              ...
              <Link className="px-4 py-2 rounded-xl border" to="/vendor">
                لوحة تحكم المالك (لملاك عربة الطعام فقط)
              </Link>
            ...
            {!user.emailVerified && (
              <div className="p-3 rounded-xl bg-yellow-50 text-yellow-800 text-sm">
               بندخلك هالمرة بس المرة الجاية لازم تتحقق من ايميلك
              </div>
            )}
          </div>
        )}
